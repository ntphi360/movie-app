  ...
  return (
    <div className='col my-2 text-white'>
      <div onClick={handleClick}  className='max-w-[300px] w-sm-s w-sm-sm w-sm-tab relative inline-block cursor-pointer '>
        <img className='w-full h-auto block rounded hover:bg-black/80 opacity-1 hover:opacity-50' src={`https://image.tmdb.org/t/p/w300/${item?.poster_path}`} alt={item?.title}/>
